...
% Knockout TNF-alpha
p_ifntnf_knockout = p;
%p_ifntnf_knockout.p_alpha_T = 0; % Set TNF-alpha production to zero
...
p_ifntnf_knockout.p_Gamma_K = 0;
[timeIFNGTNF, solIFNGTNF] = COVID_IMMUNE_MODEL(p_ifntnf_knockout, tspan);
...
solIFNGTNF_deval = interp1(timeIFNGTNF, solIFNGTNF', time_deval);

% Call the cytokine knockout plotter
severe_IFNGTNF_knockout_plotter(time_deval, solS_deval', solIFNGTNF_deval', p);